...
import 'package:Mehvesujood/kalam/urdu/noori/nooriTrack.dart';
import 'package:Mehvesujood/main_drawer.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:hexcolor/hexcolor.dart';

class NooriListUrdu extends StatelessWidget {
  const NooriListUrdu({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          'اردو   فہرست',
          style: GoogleFonts.notoNastaliqUrdu( color: Colors.white)// TextStyle(fontFamily: 'Mehr', fontSize: 28, color: Colors.white),
        ),
