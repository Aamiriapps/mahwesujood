...
import 'package:Mehvesujood/kalam/english/sarmadi/sarmadi_TrackClassEnglish.dart';
import 'package:Mehvesujood/main_drawer.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:google_fonts/google_fonts.dart';

import 'sarmadiTrackEnglish.dart';

class SarmadiListEnglish extends StatelessWidget {
  const SarmadiListEnglish({super.key});

  // Load song titles from text file
  Future<List<String>> loadSongList() async {
    final content = await rootBundle.loadString(
      'assets/sarmadi_list/english/engList.txt', // adjust path as needed
    );
    return content
        .split('\n')
        .map((line) => line.trim())
                    ...
                    onTap: track != null
                        ? () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (_) => SarmadiTrackclassenglish(
                                  title: track['title'],
                                  nazam: track['nazam'],
