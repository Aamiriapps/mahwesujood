...
import 'arabiTrackEnglish.dart';

class Arabilistenglish extends StatelessWidget {
  const Arabilistenglish({super.key});

  // Load song titles from text file
  Future<List<String>> loadSongList() async {
    final content = await rootBundle.loadString(
      'assets/arabi_list/english/engList.txt', // adjust path as needed
    );
    return content
        .split('\n')
        .map((line) => line.trim())
