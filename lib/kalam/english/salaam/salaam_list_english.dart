...
import 'salaamTrackEnglish.dart';

class SalaamListEnglish extends StatelessWidget {
  const SalaamListEnglish({super.key});

  // Load song titles from text file
  Future<List<String>> loadSongList() async {
    final content = await rootBundle.loadString(
      'assets/salaam_list/english/engList.txt', // adjust path as needed
    );
    return content
        .split('\n')
        .map((line) => line.trim())
